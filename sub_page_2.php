        ...
        <section class="container">
            <div class="panels clear">
                        ...
                        <div class="panel_content_area">
                            <div class="panel_content">
                                <div class="panel_content_text mainDesc">
                                    <em>Launched in 2008, e-flux journal is a monthly art publication featuring essays
                                        and contributions by some of the most engaged artists and thinkers working
                                        today. The journal is available online, in PDF format, and in print through a
                                        ...
                                        <br>
                                        <br>
                                        <strong>Managing & Copy Editor</strong><br>
                                        Mike Andrews
                                        <br>
                                        <br>
                ...
                <?php
                                    ...
                                    $sql="select * from eflux_table_2  order by num desc";
                ...
                <div class="panel_container">
                    <div class="panel_label">
                        <div class="panel_label_text">
                            <h2>
                                <?=substr($title,7,12);?> <?=substr($regist_day,0,7);?>
                            </h2>
                        </div>
                    </div>
                    <div class="panel_scrolling_area">
