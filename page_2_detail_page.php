...
<body id="body">
    <?php
        ...
        $sql="select * from eflux_table_2 where num = $num order by num desc";
    ...
    <div class="wrap">
        ...
        <section class="main_nav" id="navbar">
            <div class="main_nav_list clear">
                ...
                <p>Journal</p>
                <em><?=substr($regist_day,0,7);?> - <?=$title?></em>
        ...
        <section class="main_contents">
            <div class="content_title">
                <h4><?=$title?> <?=substr($regist_day,0,7);?></h4>

                <h2>Editors</h2>
                <h1>Editorial</h1>
            </div>
            <div class="content_text">
                <p><?=nl2br($row['main_txt']);?></p>
            </div>
            <?php
         }
         ?>
