...
<head>
    ...
    <link rel="stylesheet" href="css/sub_page_3.css?v=<?php echo time(); ?>" />
    <link rel="stylesheet" href="css/media.css?v=<?php echo time(); ?>" />
    <title>e-flux Reviews</title>
</head>
        ...
        <section class="container">
            <div class="panels panels_sub clear">
                        ...
                        <div class="panel_content_area">
                            <div class="panel_content">
                                <div class="panel_content_text mainDesc clear">
                                    <em>ART AGENDA EDITORIAL
                                        <br>
                                        <br>
                                        art-agenda is the division of e-flux dedicated to contemporary art
                                        criticism.<br> It
                                        was established in 2010 to ensure that independent criticism continues to play a
                                        fundamental role in today’s discourses around art and culture.
                                        <br><br>
                                        Our contributors constitute a global network of critically engaged authors:
                                        writers, academics, artists, and curators. Reviews of significant exhibitions in
                                        museums, galleries, and independent spaces worldwide are complemented by essays,
                                        interviews, and reports from the field of contemporary art.
                                        <br><br>
                                        All our articles and features are freely available on art-agenda's website and
                                        are circulated via email to our network of over 50,000 subscribers worldwide.
                                        <br><br>
                                        We invite writers who would like to contribute to get in touch with us via the
                                        email address listed below.<br> We particularly welcome pitches from writers of
                                        color and critics based outside the United States and Europe.
                                        <br><br>
                                        Editor-in-chief: Ben Eastham<br>
                                        Editors: Patrick Langley / Francesca Wade<br>
                                        Social media editor: Novuyo Moyo<br>
                                        Contact: info [​at​] art-agenda.com
                ...
                <?php
                                    ...
                                    $sql="select * from eflux_table_3  order by num desc";
